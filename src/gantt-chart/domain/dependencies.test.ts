...
const tasks: Task[] = [
	{id: 1, text: 'A', startDate: '2026-01-01', durationHours: 24, progress: 0, type: 'task', open: true},
	{id: 2, text: 'B', startDate: '2026-01-02', durationHours: 24, progress: 0, type: 'task', open: true},
	{id: 3, text: 'C', startDate: '2026-01-03', durationHours: 24, progress: 0, type: 'task', open: true},
];
