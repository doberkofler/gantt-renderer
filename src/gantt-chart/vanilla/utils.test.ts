...
describe('utils', () => {
	describe('buildTaskIndex', () => {
		it('maps task ids to array indices', () => {
			const tasks = [
				{id: 1, text: 'A', start_date: '2026-01-01', duration: 1, progress: 0, type: 'task' as const, open: true},
				{id: 5, text: 'B', start_date: '2026-01-02', duration: 2, progress: 0, type: 'task' as const, open: true},
				{id: 3, text: 'C', start_date: '2026-01-03', duration: 3, progress: 0, type: 'task' as const, open: true},
			];
	...
	describe('getExpandableTaskIds', () => {
		it('returns ids of tasks with children', () => {
			const tasks = [
				{id: 1, text: 'Root', start_date: '2026-01-01', duration: 5, progress: 0, type: 'project' as const, open: true},
				{id: 2, text: 'Child', start_date: '2026-01-01', duration: 3, progress: 0, type: 'task' as const, parent: 1, open: true},
				{id: 3, text: 'Leaf', start_date: '2026-01-01', duration: 2, progress: 0, type: 'task' as const, open: true},
			];
		...
		it('returns empty set when no tasks have children', () => {
			const tasks = [{id: 1, text: 'A', start_date: '2026-01-01', duration: 1, progress: 0, type: 'task' as const, open: true}];
	...
	describe('getInitialExpandedIds', () => {
		it('returns ids of tasks marked open that have children', () => {
			const tasks = [
				{id: 1, text: 'Root', start_date: '2026-01-01', duration: 5, progress: 0, type: 'project' as const, open: true},
				{id: 2, text: 'Child', start_date: '2026-01-01', duration: 3, progress: 0, type: 'task' as const, parent: 1, open: true},
				{id: 3, text: 'Closed', start_date: '2026-01-01', duration: 5, progress: 0, type: 'project' as const, open: false},
				{id: 4, text: 'Child2', start_date: '2026-01-01', duration: 3, progress: 0, type: 'task' as const, parent: 3, open: true},
			];
