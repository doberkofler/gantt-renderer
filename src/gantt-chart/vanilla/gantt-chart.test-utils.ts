...
export const INPUT: GanttInput = {
	tasks: [
		{id: 1, text: 'Customer Portal Release', startDate: '2026-02-01', durationHours: 288, progress: 0.4, type: 'project', open: true},
		{id: 2, text: 'Discovery Sprint', startDate: '2026-02-01', durationHours: 72, progress: 0.9, type: 'task', parent: 1, open: true},
		{id: 3, text: 'API Implementation', startDate: '2026-02-04', durationHours: 120, progress: 0.45, type: 'task', parent: 1, open: true},
		{id: 4, text: 'Frontend Implementation', startDate: '2026-02-05', durationHours: 120, progress: 0.3, type: 'task', parent: 1, open: true},
		{id: 5, text: 'UAT Exit Milestone', startDate: '2026-02-12', durationHours: 0, progress: 0, type: 'milestone', parent: 1, open: true},
	],
	links: [
